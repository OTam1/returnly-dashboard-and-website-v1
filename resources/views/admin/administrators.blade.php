                            ...
                            <tbody>
                                @foreach ($administrators as $admin)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold mb-0">{{ $admin->location }}</p>
                                        </td>
                                        <td class="text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $admin->about_me }}</span>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.EditStatus', ['id' => $admin->id]) }}" class="mx-3"
