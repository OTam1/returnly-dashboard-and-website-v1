...
<head>
    ...
    <!-- Page Title -->
    <title>Digital Marketing | MegaOne | Creative HTML5 Template</title>
    <!-- Favicon -->
    ...
    <link rel="stylesheet" href="../landing-page-assetes/css/mediaelementplayer.css">
    <link rel="stylesheet" href="../landing-page-assetes/css/mejs-controls.svg">
    <!-- Style Sheet -->
...
<header>
    ...
    <nav id="my-nav1" class="navbar navbar-expand-lg navbar-light rounded-bar transparent-bar bg-white mt-0">

        <div class="logo small-screen">
            <a href="../index-digital-marketing.html" class="scroll"><img src="../landing-page-assetes/img/logo.png" alt="Logo Img"></a>
        </div>
                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <div class="col-6 p-0">
                            <ul id="primary" class="navbar-nav text-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="../index-digital-marketing.html">home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../index-digital-marketing.html#feature">about</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../index-digital-marketing.html#gallery">work</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../index-digital-marketing.html#testimonial">clients</a>
                                </li>
                                <li class="nav-item">
                                    <a href="../index-digital-marketing.html#contact" class="btn btn-slider pink-btn rounded-pill">contact</a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="side-menu hidden">
        <div class="inner-wrapper">
            ...
            <nav class="side-nav w-100">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link scroll" href="../index-digital-marketing.html#home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scroll" href="../index-digital-marketing.html#feature">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scroll" href="../index-digital-marketing.html#gallery">Work</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scroll" href="../index-digital-marketing.html#testimonial">Clients</a>
                    </li>
                    <li class="nav-item">
                        <a href="../index-digital-marketing.html#contact" class="btn btn-slider white-btn rounded-pill">Contact</a>
                    </li>
                </ul>
            </nav>
            ...
            <div class="row pt-lg-5">
                ...
                <div class="col-sm-12 col-ms-8 col-lg-8">
                    <div class="text_minimal pt-0">
                        ...
                        <h1 class="pt-3 font-weight-bold blog_detail-heading text-yellow">Fund Raising</h1>
                    ...
                    <div class="row mt-70 pl-3 pr-3">
                        <video id="player1" poster="img/vedio-poster.jpg" controls="controls" style="max-width: 100%;" playsinline>
                    ...
                    <div class="quote_text">
                        <p class="quote">Business has to be Involving, it has to Exercise your Creative Instincts.</p>
                    </div>
                    <p class="text_dummy pt-3">Nam ut rutrum ex, venenatis sollicitudin urna. Aliquam erat volutpat. Integer eu ipsum sem.
                    ...
                    <div class="blogN_images">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 pr-md-1 pr-lg-1">
                                <img class="image_blogS" src="img/standalone1.jpg" alt="">
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 pl-md-1 pl-lg-1 padding_blog-img"><img class="image_blogS" src="img/standalone2.jpg" alt=""></div>
                            <div class="col-12 pt-2"> <img class="image_blogL" src="img/standalone3.jpg" alt=""></div>
                        </div>
                    </div>
                    ...
                    <div class="written">
                        <div class="written_outerbox mt-5 display">
                            <img class="written_img" src="img/comment-img.jpg" alt="">
                    ...
                    <div class="comment">
                        <div class="comment_write">
                            ...
                            <p class="text_dummy mt-1">Nam ut rutrum ex, venenatis sollicitudin urna. Aliquam erat volutpat. Integer eu ipsum sem.
                                Ut lacus vestibulum maximus suscipit.</p>
                        </div>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-slider pink-btn rounded-pill w-100" id="submit_btn">SUBMIT REQUEST</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12 pr-0 pl-0">
                                    <div class="topic_outerbox mt-4">
                                        ...
                                        <div class="inner-box">
                                            <ul>
                                                <li><a href="#">Team</a> <span class="dots">...................</span>4</li>
                                                <li><a href="#">Creative</a> <span class="dots pr-1">.................</span>5</li>
                                                <li><a href="#">Business </a> <span class="dots pr-1">................</span>3</li>
                                                <li><a href="#">Work</a> <span class="dots">...................</span> 8</li>
                                                <li><a href="#">Design</a> <span class="dots">..................</span>6</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="outer_popular mt-4">
                                        ...
                                        <div class="outer mt-4 display">
                                            <div class="popular_image">
                                                <a href="#"><img src="img/popular1.jpg" alt="popular image"></a>
                                            </div>
                                            <div class="text_post">
                                        ...
                                        <div class="outer pt-lg-3 display">
                                            <div class="popular_image">
                                                <a href="#"><img src="img/popular2.jpg" alt="audio image"></a>
                                            </div>
                                            <div class="text_post">
                                        ...
                                        <div class="outer pt-lg-3 display">
                                            <div class="popular_image">
                                                <a href="#"><img src="img/popular3.jpg" alt="standard image"></a>
                                            </div>
                                            <div class="text_post">
                                                <p class="main">Standard Post...</p>
                                    ...
                                    <div class="topic_outerbox mt-4">
                                        ...
                                        <div class="inner-box1">
                                            <ul>
                                                ...
                                                <li><a href="#">Jan 2019</a> <span class="dots">...............</span>6</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 pr-0 pl-0 pt-4">
                                    <img class="sale_img" src="img/sale-img.jpg" alt="advertisement image">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="info footer_text"><i class="far fa-copyright"></i>2023 MegaOne. Made with love by themesindustry</p>
            </div>
        </div>
    </div>
</section>
