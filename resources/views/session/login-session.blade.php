  ...
  <main class="main-content  mt-0">
    <section>
      <div class="page-header min-vh-75">
        <div class="container">
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto" dir="{{__('dashboard.dir')}}">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">{{__('dashboard.welcome')}}</h3>
                  <p class="mb-0">{{__('dashboard.get-to')}}</p>
                ...
                <small class="text-muted">{{__('dashboard.forgot')}} 
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">{{__('dashboard.here')}} </a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                    {{__('dashboard.dont-have-acc')}} 
                    <a href="register" class="text-info text-gradient font-weight-bold">{{__('dashboard.signup')}} </a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image: url(../assets/img/curved-images/curved6.jpeg);
